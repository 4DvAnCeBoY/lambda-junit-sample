...
public class JunitTodo implements SauceOnDemandSessionIdProvider {

	
    public static String username = "asad360logica";
    public static String accesskey = "4b140c78-2f70-4e2b-a733-e556e02ecde9";
   ...
   // public SauceOnDemandTestWatcher resultReportingTestWatcher = new SauceOnDemandTestWatcher(this, authentication);
    ...
    public void junitTodoTest()  {
        ...
        String spanText = ((RemoteWebDriver) driver).findElementByXPath("/html/body/div/div/div/ul/li[6]/span").getText();
    ...
    public JunitTodo(String os, String version, String browser, String deviceName, String deviceOrientation) {
        super();
        this.os = os;
